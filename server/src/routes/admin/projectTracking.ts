...
const constructionSchema = z.object({
  ...
  gba: z.boolean().nullable().optional(),
  gba_am: z.string().nullable().optional(),
  sina: z.boolean().nullable().optional(),
  sina_am: z.string().nullable().optional(),
  mpp: z.boolean().nullable().optional(),
  mpp_am: z.string().nullable().optional(),
  pronovo: z.boolean().nullable().optional(),
  pronovo_am: z.string().nullable().optional(),
