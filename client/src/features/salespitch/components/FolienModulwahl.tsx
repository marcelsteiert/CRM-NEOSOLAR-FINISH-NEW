 ...
 * regelmaessig nach der Optik – vollschwarze Module sind ein echtes
 * Kaufargument und ein Aufpreis, der sofort in der Offerte stehen soll.
 * Deshalb ist die Folie klickbar und aendert direkt die Rechnung.
 */
  ...
  return (
    <div className="h-full flex flex-col justify-center px-6 sm:px-10 max-w-6xl mx-auto w-full">
      ...
      <h2 className="text-[28px] sm:text-[33px] font-bold text-text mb-1.5 leading-tight">
        Leistung ist Standard – die Optik entscheiden Sie
      </h2>
      <p className="text-[13px] text-text-sec mb-6">
        Alle drei Module haben dieselben Garantien und dieselbe Prüfung. Der Unterschied
        liegt im Aussehen auf dem Dach und in der Leistung je Quadratmeter.
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,32%)_minmax(0,1fr)] gap-7 items-center min-h-0">
        ...
        >
          <img
            ...
            style={{ maxHeight: '38vh', filter: 'drop-shadow(0 22px 42px rgba(0,0,0,0.55))' }}
            loading="lazy"
          />
        </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-[12.5px] text-text-sec mt-1.5 leading-snug">{m.optik}</div>
                  </div>
                </div>
              </button>
            )
