...
import { useKanbanColumns, useUpdateKanbanColumns, type KanbanColumn } from '@/hooks/useAdmin'
...
export default function AppointmentKanbanSection() {
  const { data: res, isLoading } = useKanbanColumns()
  const updateMut = useUpdateKanbanColumns()
  ...
  return (
    <div className="space-y-5">
      ...
      >
        Hier kannst du die Spalten des Termin-Kanban-Boards benennen, einfaerben und per Drag & Drop sortieren.
        ...
        {columns.map((col, idx) => (
          ...
          >
            ...
            <div className="w-[130px] shrink-0">
              <p className="text-[9px] font-bold uppercase tracking-[0.08em] text-text-dim">Status-Key</p>
              <p className="text-[12px] font-mono text-text-sec">{col.status}</p>
            </div>
